<x-app-layout>
    ...
    <style>
        ...
        .role-option input:checked + .role-card {
            border-color:var(--blue); background:rgba(30,111,217,0.05);
        }
    ...
    <div class="page">
        ...
        <div class="page-header">
            <div>
                <h1><i class="fas fa-user-plus" style="color:var(--blue);margin-right:10px;font-size:1.2rem"></i>Tambah User</h1>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <h6 class="form-card-title">Data User Baru</h6>
            </div>
            <div class="form-card-body">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    {{-- Password --}}
                    <div class="section-label" style="margin-top:24px">Password</div>
